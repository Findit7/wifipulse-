  ...
  MigrationStrategy get migration {
    return MigrationStrategy(
      ...
      onUpgrade: (Migrator m, int from, int to) async {
        if (from < 2) {
          await m.addColumn(usageAnalytics, usageAnalytics.sessionDuration);
          await m.addColumn(usageAnalytics, usageAnalytics.foregroundUsage);
          await m.addColumn(usageAnalytics, usageAnalytics.wifiConnectionDuration);
        }
      },
    );
  }
